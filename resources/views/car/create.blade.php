    ...
    <div class="main-content">
        ...
        <form action="{{ route('car.store') }}" method="POST">
            ...
            <div class="checkbox-group">
                <label><input type="radio" name="car_type" value="รถยนต์" required> รถยนต์</label>
                <label><input type="radio" name="car_type" value="มอเตอร์ไซค์" required> มอเตอร์ไซค์</label>
            </div>
            <br>

            <button type="submit">บันทึกข้อมูล</button>
        </form>
        <a href="{{ route('car.index') }}">กลับไปหน้าหลัก</a>
    </div>
</body>
</html>